...
## 13. Update Toolkit In Existing Project

Use when toolkit has a new version and you want to pull updates into an existing project without replacing current planning docs.
...
## 14. Enable Changelog Automation

Use when you want automatic changelog updates per commit plus daily sync.
